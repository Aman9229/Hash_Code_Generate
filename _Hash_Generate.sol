...
contract hashfunction{
    ...
    return sha256(abi.encodePacked(_passward));   // SHA256 use in bitcion algo
    // keccak256 algo  will be use in ethereum
    }

}
   
    // (abi.encodePacked) string concat like as (123,45)==  (1234,5) 
